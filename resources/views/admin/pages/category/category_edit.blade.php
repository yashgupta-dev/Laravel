        ...
        <div class="row">
            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6"><h6 class="card-title">{{ __('Category Edit') }}</h6></div>
                            <div class="col-md-6">
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active">
                                            <div class="form-group required">
                                                ...
                                                <div class="col-sm-10">
                                                    @csrf
                                                    <input type="hidden" name="category_id" value=" {{ $data[0]->category_id }}"/>
                                                    <input type="text" name="name" value=" {{ $data[0]->name1 }}" placeholder="Category Name" id="input-name1" class="form-control @if(!empty($errors->first('name'))) is-invalid @endif"/>
                                ...
                                <div class="tab-pane" id="tab-data">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="path" value="{!! $data[0]->name !!}" placeholder="{{ __('Parent category') }}" id="input-parent" class="form-control @if(!empty($errors->first('path'))) is-invalid @endif @if(!empty($errors->first('parent_id'))) is-invalid @endif" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="status" id="input-status" class="form-control">
                                                ...
                                                <option value="0"selected="selected">{{ __('Disabled') }}</option>
                                                @endif                                                
                                            </select>
                                        </div>
                                    </div>
