...
<head>
	...
	<!-- endinject -->
  <!-- Layout styles -->  
	<!-- <link rel="stylesheet" href="{{asset('assets/css/demo_5/userstyle.css')}}"> -->
...
@section('footer')
  ...
  <script src="{{asset('assets/js/custome_copy.js')}}"></script>
  <!-- @notifyJs
  <x:notify-messages /> -->
  ...
  @section('myscript') @show
  @include('pusher.pusher')
