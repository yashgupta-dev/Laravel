...
<head>
	...
	<style>
		@import url(https://fonts.googleapis.com/css?family=Nunito+Sans);:root{--blue:#0e0620;--white:#fff;--green:#2ccf6d}body,html{height:100vh}body{display:flex;align-items:center;justify-content:center;font-family:"Nunito Sans";color:var(--blue);font-size:1em}button{font-family:"Nunito Sans"}svg{width:100%}h1{font-size:7.5em;margin:15px 0;font-weight:700}h2{font-weight:700}.btn{z-index:1;overflow:hidden;background:0 0;position:relative;padding:8px 50px;border-radius:30px;cursor:pointer;font-size:1em;letter-spacing:2px;transition:.2s ease;font-weight:700;margin:5px 0}.btn.green{border:4px solid var(--green);color:var(--blue)}.btn.green:before{content:"";position:absolute;left:0;top:0;width:0%;height:100%;background:var(--green);z-index:-1;transition:.2s ease}.btn.green:hover{color:var(--white);background:var(--green);transition:.2s ease}.btn.green:hover:before{width:100%}@media screen and (max-width:768px){body{display:block}.container{margin-top:70px;margin-bottom:70px}}
	</style>
</head>
<body>
<div class="container">
